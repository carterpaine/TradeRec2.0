...
if gm_mode:
    ...
    filtered_df["Value_score"] = (df["Predicted WAR"] * df["years_control"]) * (1 - df["contract_value"] / df["contract_value"].max())
    gm_display = filtered_df[["player_id", "team", "position", "Predicted WAR", "contract_value", "years_control", "WAR Gained_score"]]
