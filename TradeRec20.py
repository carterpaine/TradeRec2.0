...
if not gm_mode:
    ...
    df["benefit"] = df["Predicted WAR"] - df["gm_team_replacement_WAR"]
    ...
    st.dataframe(gm_filtered[["player_id", "team", "position", "Predicted WAR", "gm_team_replacement_WAR", "benefit"]])
...
if gm_mode:
    ...
    filtered_df["benefit_score"] = (df["Predicted WAR"] * df["years_control"]) * (1 - df["contract_value"] / df["contract_value"].max())
